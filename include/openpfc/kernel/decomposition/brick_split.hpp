 ...
 *        multiple of @ref kSpectralNodeGcds and both axes divide @p size.
 *
 ...
 */
[[nodiscard]] inline Int3 node_aware_fft_proc_grid(const Int3 &size,
                                                   int num_procs) {
  if (num_procs < kSpectralSlabMinRanks ||
      num_procs % kSpectralNodeGcds != 0) {
    return Int3{0, 0, 0};
  }
