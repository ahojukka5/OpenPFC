...
| **Observable** | Free-energy density after relaxation; reciprocal-space peak amplitudes at \(\|k\|=1\) and \(\|k\|=q_1\) (`pfc::fft::radial_average`); real-space bond-orientational order \(\psi_4\)/\(\psi_6\) (`order_parameter.hpp`) |
