...
| FD primitives | `field/fd_apply.hpp`, `field/fd_stencils.hpp`, `field/fd_symbols.hpp`, `field/periodic_spectra.hpp` | `apply_d1_along<Axis, Stencil>`, `apply_d2_along<Axis, Stencil>`, `apply_tensor_d<Mx, My, Mz, ...>`, `EvenCentralD1<Order>` (orders 2..14), `EvenCentralD2<Order>` (orders 2..20), `d2_symbol` / `d2_symbol_defect`, occupancy-matched `SpectrumFamily` Parseval errors |
